function getlagou(timesjc,trace) {
    ...
    function abcddd(timesjc,trace) {
        ...
        function _0x89ea42(timesjc) {
            var _0x150c4d = new Date(timesjc[_0x3551('0x2d')](/-/g, '/'));
        ...
        //     var _0x4bef56 ="20190507110150-8c03d930-7de6-474a-b1d4-1591e0ad2c3e";
		...
		function getsjc(timesjc){
			return _0x89ea42(timesjc);
		}
        function get(timesjc,trace) {
            
            var _0x4bef56 = trace;//user_trace_token
            var _0x5c6712 = _0x1c7889(_0x1bd82b + _0x4bef56);
            var _0x597b06 =  getsjc(timesjc);//时间搓可能是服务端的时间挫
            var _0x179ec1 = _0x55bae5(_0x5c6712, _0x597b06, 0x10);//16进制的16  2b49f9cff26a8a2a15572229278a26887e507f37cf
            var _0x32e0d2 = _0x39990b(_0x179ec1);//fc73f705e78862a87292227551a2a8a62ffc9f94b2
           
            return _0x32e0d2;
        }
        return get(timesjc,trace);
    };
    return abcddd(timesjc,trace);
}
